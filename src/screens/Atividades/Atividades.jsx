...
const ACTION_ICONS = {
    ...
    mensagem_aviso: Timeline,
    movimentacao_cobranca: Timeline,
    amizade_solicitada: PersonAdd,
    amizade_aceita: PersonAdd,
    cautela_transferencia_solicitada: SwapHoriz,
    cautela_transferida: SwapHoriz,
    cautela_transferencia_recusada: SwapHoriz,
